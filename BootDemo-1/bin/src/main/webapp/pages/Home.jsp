...
<body>
	...
	<div>
        <nav id="navbar">
           ...
           <div id="list">
               <ul>
                   <li><a href="loginForm" class="btn-1"><span><i class="fa fa-home"></i>&nbsp</span>Login</a></li>
	...
	<div>
		...
		<table border="1">
			<tr align="center">
				<td colspan="2">Welcome ${nameKey}</td>
			</tr>
			<tr align="center">
				
<td><a href="displayAll">Display</a></td>
<td><a href="find">Find user</a></td>


				<td><a href="registerForm">Register Yourself</a>
				<td><a href="loginForm">Login Yourself</a></td>

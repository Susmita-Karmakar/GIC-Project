...
<link href="https://fonts.googleapis.com/css2?family=Gudea&display=swap" rel="stylesheet">
		<style type="text/css">@import url("Find.css");body{
background-image:url("laptop.jpg");
	...
	<body>
			...
			<nav id="navbar">
				...
				<div id="list">
					<ul>
						...
						<li><a href="contact" class="btn-1"><span><i class="fa fa-phone"></i>&nbsp</span>Contact Us</a>
						</li>
		...
		<div id="main-body" class="container" align="center" style="background-repeat: no-repeat;
				...
				<div class="card" style="width: 35rem;background: #15995793;">
					...
					<div class="card-body" style="padding: 40px;">
						...
						<form action="findUser" method="post">
							<div class="mb-3">
							  <label class="form-label" style="padding: 20px;color: azure;"><i class="fa fa-question-circle"></i>&nbsp Type Name of the user here to search</label>
